        ...
        {INIT_NAV_LIST.map(({ icon, full_name, url }) => (
          <li key={full_name} className="w-full">
            <Link
              ...
              className={`${getNavLinkClassName(getLocalizeUrl(url))} -ml-3 mr-3 flex items-center gap-4 py-3 pl-3 pr-3 text-lg duration-300 hover:!text-blue-600 dark:hover:!text-blue-400 `}
            >
