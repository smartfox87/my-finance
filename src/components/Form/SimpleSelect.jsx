...
export const SimpleSelect = ({ value, options, onChange, className, ...props }) => {
  ...
  return (
    <div ref={selectRef} className={`relative text-sm dark:text-white/85 ${className}`} {...props} onKeyDown={handleKeyDown}>
      <button
        type="button"
