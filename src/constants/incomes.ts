import { SimplyFieldNames, FieldTypes } from "@/types/form";
import { ACCOUNT_FIELD, CATEGORY_FIELD, PERIOD_FIELD, SORT_FIELD } from "@/constants/fields";

export const INITIAL_INCOMES_FILTER_FIELDS = [SORT_FIELD, ACCOUNT_FIELD, CATEGORY_FIELD, PERIOD_FIELD];

export const INITIAL_INCOME_FIELDS = [
  { id: "name", label_translation: "simple.name", value: "", maxLength: 1000, type: "textarea", focus: true },
  {
    id: "account",
