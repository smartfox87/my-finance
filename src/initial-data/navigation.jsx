...
export const INIT_NAV_LIST = [
  ...
  {
    icon: <SvgIncomes className="-m-0.5 h-6 w-6 lg:h-8 lg:w-8" />,
  ...
  {
    icon: <SvgExpenses className="-m-0.5 h-6 w-6 lg:h-8 lg:w-8" />,
  ...
  {
    icon: <SvgBudgets className="h-5 w-5 lg:h-7 lg:w-7" />,
