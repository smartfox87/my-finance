...
export const INIT_NAV_LIST: { icon: ReactNode; url: string; full_name: string; short_name?: string; mobile_nav?: boolean }[] = [
  {
    icon: <SvgHome className="h-5 w-5 lg:h-6 lg:w-6" />,
    full_name: "navigation.home",
    url: "/",
  },
  {
    icon: <SvgAccounts className="h-5 w-5 lg:h-6 lg:w-6" />,
  ...
  {
    icon: <SvgIncomes className="h-6 w-6 lg:h-7 lg:w-7" />,
  ...
  {
    icon: <SvgExpenses className="h-6 w-6 lg:h-7 lg:w-7" />,
  ...
  {
    icon: <SvgBudgets className="h-6 w-6 lg:h-7 lg:w-7" />,
  ...
  {
    icon: <SvgStatistics className="h-5 w-5 lg:h-7 lg:w-7" />,
  ...
  {
    icon: <SvgProfile className="h-5 w-5 lg:h-7 lg:w-7" />,
    full_name: "navigation.profile",
    url: "/profile",
  },
  {
    icon: <SvgSettings className="h-5 w-5 lg:h-7 lg:w-7" />,
    full_name: "navigation.settings",
    url: "/settings",
  },
  {
    icon: <SvgContact className="h-5 w-5 lg:h-7 lg:w-7" />,
