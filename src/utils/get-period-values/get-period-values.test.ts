...
describe("getDatesPeriodValues", () => {
  ...
  it("returns start and end of the year when no period is provided", () => {
    const result = getPeriodValues("2023-10-01");
    expect(result).toEqual(["2023-01-01", "2023-12-31"]);
  });
});
